...
live_channel_filter_list  = [
    ...
    'ESPNAP', 'COLLG', 'NFLRDZHD', 'SC', 'SALE', 'HSN', 'HSN2', 'TruTVD', 'AAN', 'QVCPL', 'BVOV', 'LC', 'CCTV-N', 'WFN', 'OUTD', 'TVG2', 'TVG', 'SPCHN', 'ESGLBB', 'PPVSP', 'ALOCK', 'ASHOW', 'APPV', 'GIRL', 'VIVID', 'BRAZZERS', 'TENXX5', 'PPVB', 'MOVIE', 'PLBOY', 'PLBY', 'RTKN', 'HUSLR', 'XTSY', 'RFI', 'TVPOL', 'TVNINTER', 'TVN24NEW', 'AFROM', 'TRACE', 'TV5', 'Tivi5', 'ISREAL', 'RADIO', 'TVI', 'SCOLA', 'MEDIA', 'RYTHM', 'CCTV-4', ''
